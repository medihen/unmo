...
class Markov:
    ...
    def add_sentence(self, parts):
        ...
        """
        # 実装を簡単にするために、3単語以上で構成された文章のみを学習する。
        if len(parts) < 3:
            return
    ...
    def generate(self, keyword):
        ...
        # その後、prefix1, prefix2をスライドさせて始めに戻る。
